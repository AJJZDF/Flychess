...
public class WifiServer_GameManager extends Thread{
    ...
    public WifiServer_GameManager(BasicAI red,BasicAI yellow,BasicAI blue)
    {
    ...
    public WifiServer_GameManager(BasicAI red,BasicAI blue)
    {
...
//    }
    ...
    /*
    主Thread run(){// this is server
        send_To_Client(哪个玩家的turn)
        等待  筛子                  (while check is.....)
        send_To_Client(当前玩家可以选的棋子)
        等待  对应玩家选哪个棋子    (while check is.....)
