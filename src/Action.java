...
public class Action
{
    ...
    //坠落，回到停机坪,先把第playerid个玩家的第chessid个棋子移动到停机坪，
    ...
    public static int  REVERSE = 6;//旋转180度，把第playerid个玩家的第chessid个棋子旋转180度，然后不用做任何事
    public static int TURNRIGHT = 7; //右转
    public static int QUICK_MOVE = 8;//加快速度移动，主要是飞行时用的
